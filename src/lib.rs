#![doc = "Peripheral access API for SYNCRIM RV32I FASTCLIC microcontrollers (generated using svd2rust v0.31.5 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl GPIO {
    ...
    pub const PTR: *const gpio::RegisterBlock = 0x6000_0000 as *const _;
...
impl MTIME {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const mtime::RegisterBlock = 0x5000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
